...
if __name__ == "__main__":
    ...
    plt.subplot(2, 3, 2)
    generateLearningCurve(X, y, 12, 2);
    plt.subplot(2, 3, 3)
    generateLearningCurve(X, y, 18, 3);
    plt.subplot(2, 3, 4)
    generateLearningCurve(X, y, 7, .1);
    plt.subplot(2, 3, 5)
    generateLearningCurve(X, y, 20, 1);
    plt.subplot(2, 3, 6)
    generateLearningCurve(X, y, 15, 100);
    plt.show()
